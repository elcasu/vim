...
silent only
cd ~/prg/angularjs/angular-phonecat
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +5 app/index.html
badd +1 app/js/controllers.js
badd +1 test/unit/controllersSpec.js
args app/index.html
edit test/unit/controllersSpec.js
...
setlocal tabstop=4
setlocal tags=~/prg/angularjs/angular-phonecat/.git/javascript.tags,~/prg/angularjs/angular-phonecat/.git/tags,./tags,./TAGS,tags,TAGS
setlocal textwidth=0
setlocal thesaurus=
setlocal noundofile
...
inoremap <buffer> <SNR>48_ragtagOopen <%= 
...
setlocal tabstop=4
setlocal tags=~/prg/angularjs/angular-phonecat/.git/html.tags,~/prg/angularjs/angular-phonecat/.git/tags,./tags,./TAGS,tags,TAGS
setlocal textwidth=0
setlocal thesaurus=
setlocal noundofile
setlocal nowinfixheight
