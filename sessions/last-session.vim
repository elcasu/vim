...
set shortmess=aoO
badd +279 src/Shop/ShopBundle/Twig/ShopExtension.php
badd +0 src/Shop/ShopBundle/Resources/config/services.yml
badd +0 src/Shop/ShopBundle/Controller/ShopController.php
args src/Shop/ShopBundle/Twig/ShopExtension.php
edit src/Shop/ShopBundle/Twig/ShopExtension.php
...
exe 'vert 4resize ' . ((&columns * 96 + 96) / 192)
argglobal
enew
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 287 - ((33 * winheight(0) + 25) / 51)
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 44 - ((9 * winheight(0) + 12) / 25)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
44
...
wincmd w
argglobal
edit src/Shop/ShopBundle/Controller/ShopController.php
let s:cpo_save=&cpo
set cpo&vim
imap <buffer> <SNR>48_ragtagOclose  ><Left><Left>
inoremap <buffer> <SNR>48_ragtagOopen <?php print 
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 141 - ((7 * winheight(0) + 12) / 25)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
141
