...
let s:cpo_save=&cpo
set cpo&vim
inoremap <silent> <SNR>49_yrrecord =YRRecord3()
...
nnoremap ,k K
nnoremap ,l L
nnoremap ,W :match trailingWhitespaces //
nnoremap ,w :match trailingWhitespaces /\v +$/
...
noremap <F7> :source ~/.vim/sessions/last-session.vim
snoremap <Left> bi
snoremap <Right> a
snoremap <BS> b<BS>
...
nnoremap <silent> <SNR>49_yrrecord :call YRRecord3()
...
noremap <F6> :mksession ~/.vim/sessions/last-session.vim
noremap <C-Down> 3-
noremap <C-Up> 3+
noremap <C-Right> 3>
noremap <C-Left> 3<
...
inoremap  <Nop>
inoremap jk 
iabbr ccopy Copyright 2014 Gabriel Casullo, all rights reserved
iabbr @@ info@casu-net.com.ar
let &cpo=s:cpo_save
unlet s:cpo_save
set autoindent
...
set shortmess=aoO
badd +77 src/Shop/ShopBundle/Listener/ShopRequestListener.php
badd +1 src/Shop/ShopBundle/Listener/StoreSwitchListener.php
badd +1 src/Shop/ShopBundle/Resources/config/services.yml
badd +45 app/config/services.yml
args src/Shop/ShopBundle/Listener/ShopRequestListener.php
edit src/Shop/ShopBundle/Listener/StoreSwitchListener.php
...
exe 'vert 2resize ' . ((&columns * 92 + 96) / 192)
exe '3resize ' . ((&lines * 26 + 28) / 57)
exe 'vert 3resize ' . ((&columns * 99 + 96) / 192)
...
let s:cpo_save=&cpo
set cpo&vim
imap <buffer> <SNR>48_ragtagOclose  ><Left><Left>
inoremap <buffer> <SNR>48_ragtagOopen <?php print 
inoremap <buffer> <SNR>48_xhtmltrans <!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
inoremap <buffer> <SNR>48_htmltrans <!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
...
setlocal tabstop=4
setlocal tags=~/fjs/cms/.git/php.tags,~/fjs/cms/.git/tags,./tags,./TAGS,tags,TAGS
setlocal textwidth=0
setlocal thesaurus=
setlocal noundofile
...
wincmd w
argglobal
edit src/Shop/ShopBundle/Resources/config/services.yml
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal balloonexpr=
...
setlocal tabstop=4
setlocal tags=~/fjs/cms/.git/yaml.tags,~/fjs/cms/.git/tags,./tags,./TAGS,tags,TAGS
setlocal textwidth=0
setlocal thesaurus=
setlocal noundofile
setlocal nowinfixheight
...
wincmd w
argglobal
edit src/Shop/ShopBundle/Listener/ShopRequestListener.php
let s:cpo_save=&cpo
set cpo&vim
imap <buffer> <SNR>48_ragtagOclose  ><Left><Left>
inoremap <buffer> <SNR>48_ragtagOopen <?php print 
